...
public class FlightActivity extends AppCompatActivity implements ARDiscoveryServicesDevicesListUpdatedReceiverDelegate {


    private static String TAG = FlightActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(FlightActivity.this, ControlActivity.class);
                intent.putExtra(ControlActivity.EXTRA_DEVICE_SERVICE, service);
        ...
        if (ardiscoveryService != null)
        {
            ...
            if(list != null)
            {
                for (ARDiscoveryDeviceService service : list)
                {
                    ...
                    if ((ARDISCOVERY_PRODUCT_ENUM.ARDISCOVERY_PRODUCT_ARDRONE.equals(product)) ||(ARDISCOVERY_PRODUCT_ENUM.ARDISCOVERY_PRODUCT_BEBOP_2.equals(product)))
                    {
